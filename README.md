...
## How to install
 ...
 3. At `[YOUR_PROJECT_NAME]/Plugins/DiscordGSDK/ThirdParty/`, create an `Discord` folder and copy `.h` and `.cpp` files of the `cpp/` folder to this folder from Discord GameSDK zip file.
 4. Follow the steps below for each OS
 5. Build your UE4 project
 6. Launch the editor, and enable this plugin.

#### Windows
 - At `[YOUR_PROJECT_NAME]/Plugins/DiscordGSDK/ThirdParty/`, create a `Win64` folder
...
#### Mac
- At `[YOUR_PROJECT_NAME]/Plugins/DiscordGSDK/ThirdParty/`, create a `Mac` folder
...
#### Linux
- At `[YOUR_PROJECT_NAME]/Plugins/DiscordGSDK/ThirdParty/`, create a `Linux` folder
